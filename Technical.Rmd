...
iex_endpoint <- function(version = "1.0",params = c("stock","market","batch")) {
...
iex_batch <- function(symbols, range, filter = NULL) {
  ...
  (url <- httr::modify_url(iex_endpoint(), query = paste(q,sep="/")))
}
...
TS.adxsar$MSFT <- tidyquant::tq_get("MSFT",get = "stock.prices")
